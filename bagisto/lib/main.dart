...
import 'dart:io';
import 'package:bagisto/services/api_client.dart';
import 'package:bagisto/utils/app_global_data.dart';
import 'package:bagisto/utils/application_localization.dart';
import 'package:bagisto/utils/mobikul_theme.dart';
import 'package:bagisto/utils/route_constants.dart';
import 'package:bagisto/utils/server_configuration.dart';
import 'package:bagisto/utils/shared_preference_helper.dart';
import 'package:flutter/material.dart';

import 'package:bagisto/screens/home_page/data_model/get_categories_drawer_data_model.dart';
import 'package:bagisto/screens/product_screen/utils/index.dart';
import 'package:bagisto/utils/app_navigation.dart';
import 'package:bagisto/utils/push_notifications_manager.dart';
import 'package:bagisto/utils/theme_provider.dart';
...
Future<void> main() async {
  ...
  hiveRegisterAdapter();
  loadWebContent();
  runApp(RestartWidget(child: BagistoApp(GlobalData.locale)));
}
...
class BagistoApp extends StatefulWidget {
  const BagistoApp(this.selectedLanguage, {Key? key}) : super(key: key);
