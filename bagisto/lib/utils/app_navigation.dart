...
import 'package:bagisto/data_model/app_route_arguments.dart';
import 'package:bagisto/data_model/order_model/order_detail_model.dart';
import 'package:bagisto/screens/account/bloc/account_info_bloc.dart';
import 'package:bagisto/screens/account/bloc/account_info_repository.dart';
import 'package:bagisto/screens/account/view/account_screen.dart';
import 'package:bagisto/screens/add_edit_address/bloc/add_edit_address_bloc.dart';
import 'package:bagisto/screens/add_edit_address/bloc/add_edit_address_repository.dart';
import 'package:bagisto/screens/address_list/bloc/address_bloc.dart';
import 'package:bagisto/screens/address_list/bloc/address_repository.dart';
import 'package:bagisto/screens/address_list/view/address_screen.dart';
import 'package:bagisto/screens/categories_screen/bloc/categories_bloc.dart';
import 'package:bagisto/screens/categories_screen/bloc/categories_repository.dart';
import 'package:bagisto/screens/categories_screen/categories_screen.dart';
import 'package:bagisto/screens/drawer/bloc/drawer_bloc.dart';
import 'package:bagisto/screens/drawer/bloc/drawer_repository.dart';
import 'package:bagisto/screens/forget_password/bloc/forget_password_bloc.dart';
import 'package:bagisto/screens/forget_password/bloc/forget_password_repository.dart';
import 'package:bagisto/screens/forget_password/view/forget_password.dart';
import 'package:bagisto/screens/gdpr/view/gdpr_screen.dart';
import 'package:bagisto/screens/home_page/bloc/home_page_bloc.dart';
import 'package:bagisto/screens/home_page/bloc/home_page_repository.dart';
import 'package:bagisto/screens/home_page/home_page.dart';
import 'package:bagisto/screens/order_detail/bloc/order_detail_bloc.dart';
import 'package:bagisto/screens/order_detail/bloc/order_detail_repository.dart';
import 'package:bagisto/screens/order_detail/view/order_detail.dart';
import 'package:bagisto/screens/order_invoices/bloc/order_invoice_bloc.dart';
import 'package:bagisto/screens/review/bloc/review_bloc.dart';
import 'package:bagisto/screens/review/bloc/review_repo.dart';
import 'package:bagisto/screens/review/screen/reviews.dart';
import 'package:bagisto/screens/sign_in/bloc/sign_in_bloc.dart';
import 'package:bagisto/screens/sign_in/bloc/sign_in_repository.dart';
import 'package:bagisto/screens/sign_in/view/sign_in_screen.dart';
import 'package:bagisto/screens/sign_up/bloc/sign_up_bloc.dart';
import 'package:bagisto/screens/sign_up/bloc/sign_up_repository.dart';
import 'package:bagisto/screens/sign_up/view/sign_up.dart';
import 'package:bagisto/screens/splash_screen/view/splash_screen.dart';
import 'package:bagisto/utils/route_constants.dart';
import 'package:bagisto/widgets/gdpr_webview.dart';
...
Route<dynamic>? generateRoute(RouteSettings settings) {
  ...
  switch (settings.name) {
    ...
    case signIn:
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => SignInBloc(repository: SignInRepositoryImp()),
    ...
    case signUp:
      ...
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => SignUpBloc(repository: SignUpRepositoryImp()),
      ...
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => ReviewsBloc(
                    repository: ReviewsRepositoryImp(),
                    context: context,
                  ),
    ...
    case compareScreen:
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => CompareScreenBloc(CompareScreenRepositoryImp()),
    ...
    case downloadableProductScreen:
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => DownloadableProductsBloc(
    ...
    case drawerSubCategoryScreen:
      ...
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => DrawerSubCategoriesBloc(DrawerSubCategoryRepo()),
    ...
    case shipmentDetails:
      ...
      return MaterialPageRoute(
        builder:
            (_) => BlocProvider(
              create:
                  (context) => OrderShipmentsBloc(
                    repository: OrderShipmentsRepositoryImp(),
                  ),
    ...
    case commonWebView:
      ...
      return MaterialPageRoute(
        builder:
            (_) => CommonWebView(redirectUrl: item?.url, title: item?.title),
      );
    case gdpr:
      return MaterialPageRoute(
        builder:
