...
class FetchAddAddressState extends AddEditAddressBaseState {
  ...
  FetchAddAddressState.success({this.baseModel, this.successMsg})
...
class FetchEditAddressState extends AddEditAddressBaseState {
  ...
  FetchEditAddressState.success({this.updateAddressModel, this.successMsg})
    : status = AddEditStatus.success;

  FetchEditAddressState.fail({this.error}) : status = AddEditStatus.fail;

  List<Object> get props => [
    if (updateAddressModel != null) updateAddressModel! else "",
  ];
}
...
class AddressCountryState extends AddEditAddressBaseState {
  ...
  AddressCountryState.success({this.countryData, this.successMsg})
    : status = AddEditStatus.success;
