...
class ShippingAndPaymentInfo extends StatelessWidget {
  ...
  const ShippingAndPaymentInfo({Key? key, this.orderDetailModel})
    : super(key: key);
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Text(
              StringConstants.shippingAndPaymentInfo.localized().toUpperCase(),
        ...
        if (orderDetailModel?.shippingTitle != null)
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  StringConstants.shippingMethod.localized().toUpperCase(),
                  style: Theme.of(context).textTheme.labelLarge,
                ),
                const SizedBox(height: AppSizes.spacingNormal),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSizes.spacingNormal),
              Text(orderDetailModel?.payment?.methodTitle ?? ""),
            ],
          ),
        ),
      ],
