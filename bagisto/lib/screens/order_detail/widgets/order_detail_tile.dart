...
import 'package:bagisto/screens/order_detail/utils/index.dart';
import 'package:bagisto/screens/order_detail/widgets/shipping_payment_info.dart';
...
class OrderDetailTile extends StatelessWidget with OrderStatusBGColorHelper {
  ...
  Widget build(BuildContext context) {
    return Container(child: _getOrderDetail(context));
  }
                ...
                children: [
                  ...
                  if ((orderDetailModel?.items ?? []).isNotEmpty &&
                    ...
                    shipmentInvoiceDetails(
                      StringConstants.invoiceDetails,
                      invoiceDetails,
                      orderDetailModel,
                      context,
                    ),
                  ...
                  if ((orderDetailModel?.items ?? []).isNotEmpty &&
                      orderDetailModel?.items?[0].qtyShipped != 0)
                    shipmentInvoiceDetails(
                      StringConstants.shipmentDetails,
                      shipmentDetails,
                      orderDetailModel,
                      context,
                    ),
