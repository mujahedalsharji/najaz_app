...
import 'package:bagisto/data_model/graphql_base_model.dart';
...
class OrderDetailFetchDataState extends OrderDetailBaseState {
  ...
  OrderDetailFetchDataState.success({this.orderDetailModel})
    : status = OrderDetailStatus.success;
  OrderDetailFetchDataState.fail({this.error})
    : status = OrderDetailStatus.fail;
...
class CancelOrderState extends OrderDetailBaseState {
  ...
  String? successMsg;
  BaseModel? baseModel;
  CancelOrderState.success({this.successMsg, this.baseModel})
    : status = OrderDetailStatus.success;
...
class ReOrderState extends OrderDetailBaseState {
  ...
  ReOrderState.success({this.message, this.model})
    : status = OrderDetailStatus.success;
