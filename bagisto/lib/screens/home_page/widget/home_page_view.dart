...
import 'package:bagisto/screens/home_page/data_model/theme_customization.dart';
import 'package:bagisto/screens/home_page/utils/index.dart';
import 'package:bagisto/screens/home_page/widget/service_content.dart';
import 'package:bagisto/screens/home_page/widget/static_content_widget.dart';
...
class _HomePageViewState extends State<HomePageView> {
  ...
  void initState() {
    htmlHeight = List.generate(
      widget.customHomeData?.themeCustomization?.length ?? 0,
      (index) => 1,
    );
    super.initState();
  }
                          ...
                          ? Column(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: ClipOval(
                                  child: ImageView(url: item?.logoUrl ?? ""),
                                ),
                              ),
    ...
    customHomeData?.themeCustomization?.forEach((element) {
      switch (element.type) {
        ...
        case 'services_content':
          ...
          break;
        case "image_carousel":
          homeWidgets.add(CarousalSlider(sliders: element));
          break;
        case "static_content":
          log(
            ...
            homeWidgets.add(
              SizedBox(
                ...
                child: NewProductView(
                  ...
                  filters:
                      element.translations?.firstOrNull?.options?.filters
                          ?.map((f) => f.toJson())
                          .toList(),
                ),
              ),
