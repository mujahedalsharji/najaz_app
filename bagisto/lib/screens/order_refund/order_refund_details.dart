import 'package:bagisto/screens/order_refund/utils/index.dart';
...
class _OrderRefundScreenState extends State<OrderRefundScreen> {
  ...
  void initState() {
    ...
    orderRefundBloc?.add(
      OrderRefundFetchDataEvent(widget.orderDetailsModel?.id ?? 0),
    );
    super.initState();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    getOrdersRow(
                      ...
                      refundList?.viewRefunds?[0].formattedPrice?.subTotal ??
                          "",
                      context,
                    ),
                    getOrdersRow(
                    ...
                    getOrdersRow(
                      ...
                      refundList?.viewRefunds?[0].formattedPrice?.adjustmentFee
                              .toString() ??
                          "",
                      context,
                    ),
                    getOrdersRow(
                      ...
                      refundList?.viewRefunds?[0].formattedPrice?.grandTotal ??
                          "",
                      context,
                    ),
                    const Divider(),
    ...
    return refundModel?.map((ViewRefunds? refunds) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "${StringConstants.refunds.localized()} #${refunds?.id}",
              style: Theme.of(
                context,
              ...
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    childData(
                      StringConstants.sku,
                      refunds?.items?[index].sku ?? "",
                      context,
                    ),
                    childData(
                      StringConstants.name,
                      refunds?.items?[index].name ?? "",
                      context,
                    ),
                    childData(
                    ...
                    childData(
                      StringConstants.qty,
                      refunds?.items?[index].qty.toString() ?? "",
                      context,
                    ),
                    childData(
                      StringConstants.subTotal,
