...
import '../bloc/save_order_event.dart';
import '../bloc/save_oredr_state.dart';
...
class _CheckOutSaveOrderState extends State<CheckOutSaveOrder> {
  ...
  void _loadPaypalConfig(String? method) {
    try {
      ...
      paypalClientSecret = _getConfigValue(
        _getClientSecretKeyForMethod(method),
      );
      ...
      "transactions": [
        {
          ...
          "item_list": {"items": items, "shipping_address": shippingAddress},
        },
      ],
    };
  }
