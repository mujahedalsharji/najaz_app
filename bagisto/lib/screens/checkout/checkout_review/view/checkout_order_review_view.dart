...
import 'package:bagisto/screens/checkout/checkout_review/view/widget/apply_coupon_code.dart';
import 'package:bagisto/screens/checkout/checkout_review/view/widget/checkout_order_review_loader_view.dart';
import 'package:bagisto/screens/checkout/checkout_review/view/widget/order_summary.dart';
import 'package:bagisto/screens/checkout/data_model/save_payment_model.dart';
import 'package:bagisto/screens/checkout/utils/index.dart';

import '../../../../utils/index.dart';
import '../bloc/checkout_review_event.dart';
import '../bloc/checkout_review_state.dart';
...
class _CheckoutOrderReviewViewState extends State<CheckoutOrderReviewView> {
  ...
  void initState() {
    ...
    checkOutReviewBloc?.add(
      CheckOutReviewSavePaymentEvent(paymentMethod: widget.paymentId),
    );
    super.initState();
  }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: AppSizes.spacingLarge),
                      Text(
                        StringConstants.paymentMethods
                            .localized()
                            .toUpperCase(),
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
