...
import 'package:bagisto/screens/checkout/checkout_addres/view/widget/billing_shipping_address_view.dart';
import 'package:bagisto/screens/checkout/checkout_addres/view/widget/checkout_address_loader_view.dart';
...
import '../bloc/checkout_address_event.dart';
      ...
      listener: (BuildContext context, CheckOutBaseState state) {
        if (state is CheckOutAddressState) {
          if (state.status == CheckOutStatus.success) {
            ...
            billingAddress ??= _addressModel?.addressData?.firstWhereOrNull(
              (element) => element.isDefault ?? false,
            );
            shippingAddress ??= _addressModel?.addressData?.firstWhereOrNull(
              (element) => element.isDefault ?? false,
            );
