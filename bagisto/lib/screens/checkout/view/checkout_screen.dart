    ...
    switch (currentIndex) {
      case 1:
        return isUser
            ...
            : BlocProvider(
              create:
                  (context) => GuestAddressBloc(GuestAddressRepositoryImp()),
      ...
      case 3:
        return BlocProvider(
          create:
              (context) => CheckOutPaymentBloc(CheckOutPaymentRepositoryImp()),
      ...
      case 4:
        return BlocProvider(
          create:
              (context) => CheckOutReviewBloc(CheckOutReviewRepositoryImp()),
                              ...
                              if (currentIndex < 5) {
                                if (currentIndex == 2 && shippingId == '') {
                                  ...
                                  if (currentIndex == 1 &&
                                    ...
                                    ShowMessage.warningNotification(
                                      StringConstants.pleaseFillShippingAddress
                                          .localized(),
                                      context,
                                    );
                                  }
                              ...
                              if (currentIndex == 2 && shippingId == '') {
                                ...
                                ShowMessage.warningNotification(
                                  ...
                                  billingAddress ==
                                      null) /*||(billing?['address1']==null)*/ ) {
                                ShowMessage.warningNotification(
                                  StringConstants.pleaseFillAddress.localized(),
                                  context,
                                );
                              } else {
                                setState(() {
