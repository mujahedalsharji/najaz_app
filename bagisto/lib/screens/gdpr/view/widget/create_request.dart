import 'package:bagisto/screens/account/utils/index.dart';
import 'package:bagisto/screens/gdpr/bloc/gdpr_bloc.dart';
import 'package:bagisto/screens/gdpr/bloc/gdpr_event.dart';
import 'package:bagisto/screens/review/utils/index.dart';

enum GdprRequestType { DELETE, UPDATE }
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> createGdprRequest() async {
      if (!_formKey.currentState!.validate()) {
        ...
        if (gdprBloc != null) {
          gdprBloc!.add(
            CreateGdprRequest(type: selectedType, message: message.trim()),
          );
                  ...
                  child: Column(
                    children: [
                      DropdownButtonFormField<Enum>(
                        ...
                        items: [
                          DropdownMenuItem(
                            ...
                            child: Text(StringConstants.delete.localized()),
                          ),
                          DropdownMenuItem(
                            value: GdprRequestType.UPDATE,
                            child: Text(StringConstants.update.localized()),
                          ),
                        ],
                        onChanged: (value) {
                          setState(
                      ...
                      TextFormField(
                        ...
                        maxLines: 4,
                        decoration: InputDecoration(
                          labelText: '${StringConstants.message.localized()} *',
                          labelStyle: Theme.of(context).textTheme.labelSmall,
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.all(Radius.circular(12)),
                            borderSide: BorderSide(
