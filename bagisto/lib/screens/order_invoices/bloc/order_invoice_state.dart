...
import 'package:bagisto/data_model/order_model/order_invoices_model.dart';
...
class OrderInvoiceListDataState extends OrderInvoiceBaseState {
  ...
  OrderInvoiceListDataState.success({this.invoicesList, this.error})
    : status = OrderInvoiceStatus.success;
  OrderInvoiceListDataState.fail({this.error, this.invoicesList})
    : status = OrderInvoiceStatus.fail;
