...
class AddImageView extends StatefulWidget {
  ...
  AddImageView({Key? key, this.addReviewBloc, required this.images})
    : super(key: key);
            ...
            ...?widget.images?.map(
              (image) => Stack(
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      widget.addReviewBloc?.add(
                        ImagePickerEvent(isDelete: true, deleteImage: image),
                      );
                    },
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(StringConstants.pleaseChoose.localized()),
