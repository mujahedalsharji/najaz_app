...
import 'package:bagisto/data_model/order_model/shipment_model.dart';
...
class OrderShipmentsListDataState extends OrderShipmentsBaseState {
  ...
  OrderShipmentsListDataState.success({this.shipmentData})
    : status = OrderShipmentsStatus.success;
  OrderShipmentsListDataState.fail({this.error})
    : status = OrderShipmentsStatus.fail;
