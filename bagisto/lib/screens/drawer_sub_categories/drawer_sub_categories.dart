...
import 'package:bagisto/screens/drawer/utils/index.dart';
...
class _DrawerSubCategoryViewState extends State<DrawerSubCategoryView> {
  ...
  _subCategoriesList() {
    return BlocConsumer<DrawerSubCategoriesBloc, DrawerSubCategoriesState>(
        ...
        if (state is AddToCartState) {
          ...
          if (state.status == Status.fail) {
            ShowMessage.errorNotification(
              state.graphQlBaseModel?.graphqlErrors ?? "",
              context,
            );
            ...
            appStoragePref.setCartCount(
              state.graphQlBaseModel?.cart?.itemsQty ?? 0,
            );
      ...
      builder: (context, state) {
        ...
        var allParents = categoriesData?.data?.firstWhereOrNull(
  ...
  Widget productsView(bool isLogin) {
    return ((categoriesProductData?.data ?? []).isNotEmpty || isLoading)
        ? Container(
          height:
              (categoriesProductData?.data?.isNotEmpty ?? false)
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        StringConstants.viewAllLabel.localized(),
