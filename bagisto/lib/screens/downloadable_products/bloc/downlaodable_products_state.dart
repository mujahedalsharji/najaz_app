...
class DownloadableProductsCustomerDataState
    extends DownloadableProductsBaseState {
  ...
  DownloadableProductsCustomerDataState.fail({this.error})
    : status = DownloadableProductsStatus.fail;
}
...
class DownloadProductState extends DownloadableProductsBaseState {
  ...
  DownloadProductState.fail({this.error})
    : status = DownloadableProductsStatus.fail;
}
...
class DownloadBase64ProductState extends DownloadableProductsBaseState {
  ...
  DownloadBase64ProductState.fail({this.error})
    : status = DownloadableProductsStatus.fail;
}
