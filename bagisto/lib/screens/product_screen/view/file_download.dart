...
class DownloadFile {
        ...
        await dio.download(
          ...
          onReceiveProgress: (received, total) async {
            ...
            if (progress % 5 == 0 || progress < 20) {
              PushNotificationsManager.instance.createDownloadNotification(
                100,
                progress,
                fileName,
                Platform.isAndroid ? savePath : fileName,
              );
            }
          },
        );
  ...
  Future saveBase64String(String stringUrl, String fileName) async {
  ...
  Future<void> _createFileFromString(String stringUrl, String fileName) async {
    ...
    PushNotificationsManager.instance.createDownloadNotification(
      ...
      100,
      fileName,
      Platform.isAndroid ? _localPath : fileName,
    );
  }
}
