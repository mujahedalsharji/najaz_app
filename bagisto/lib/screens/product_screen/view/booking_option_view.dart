import 'package:bagisto/data_model/product_model/booking_slots_modal.dart';
import 'package:bagisto/screens/location/view/location_screen.dart';
import 'package:bagisto/screens/product_screen/utils/index.dart';
import 'package:bagisto/screens/product_screen/view/widget/booking_product_availbility.dart';
import 'package:bagisto/screens/product_screen/view/widget/event_booking.dart';
...
class _BookingOptionViewState extends State<BookingOptionView> {
  ...
  void initState() {
    ...
    if (widget.options != null && widget.options!.isNotEmpty) {
      ...
      selectedBooking = {
        ...
        "qty": 1,
        "rentingType":
            bookingOptions?.rentalSlot != null
                ? (bookingOptions?.rentalSlot["rentingType"] != null &&
                        bookingOptions?.rentalSlot["rentingType"] ==
                            "daily_hourly")
                    ? "daily"
  ...
  int timeToMilliseconds(
    ...
    DateTime dateWithTime = DateTime(year, month, day, hours, minutes);
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(
                    left: 48.0,
                  ), // Matches the left padding of the Row widget
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
            ...
            Column(
              ...
              children: [
                ...
                if (bookingOptions?.type == "appointment" ||
                    bookingOptions?.type == "table")
                  Availability(bookingOptions: bookingOptions),
                if (bookingOptions?.type == "appointment")
                  Padding(
            ...
            Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  value:
                      widget.bookingSlotsData?.data?.any(
                                (slot) =>
                          ...
                          : null,
                  hint:
                      (widget.bookingSlotsData?.data?.isEmpty ?? true) &&
                              selectedBooking["date"] != null
                          ? Text(
                            StringConstants.noSlotsAvailable.localized(),
                            style: TextStyle(fontSize: 12),
                          )
                          : Text(
                            StringConstants.selectSlot.localized(),
                            style: TextStyle(fontSize: 12),
                          ),
                  items:
                      widget.bookingSlotsData?.data!
                ...
                Row(
                  children: [
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        hint:
                            (widget.bookingSlotsData?.data?.isEmpty ?? true) &&
                                ...
                                : Text(
                                  StringConstants.selectTimeSlot.localized(),
                                  style: TextStyle(fontSize: 12),
                                ),
                        items:
                            selectedBooking["availableBookingSlots"]
                    ...
                    const SizedBox(
                      width: 8,
                    ), // reduced from 12 to prevent overflow
                    Flexible(
                      child: DropdownButtonFormField<String>(
                  ...
                  onTap: () async {
                    ...
                    if (pickedDate != null) {
                      setState(() {
                        ...
                        setSlotsOnPickedDate = getSlotsForSelectedDate(
                          pickedDate,
                        );
                        widget.callBack?.call(selectedBooking);
                      });
                    ...
                    value:
                        widget.bookingSlotsData?.data?.any(
                                  (slot) =>
                                      jsonEncode({
                                        "from":
                                            slot?.timestamp?.split("-")[0] ??
                                            "",
                                        "to":
                                            slot?.timestamp?.split("-")[1] ??
                                            "",
                                      }) ==
              ...
              children: [
                ...
                InkWell(
                  onTap: () async {
                    DateTime? pickedDate = await showDatePicker(
                      ...
                      firstDate: DateTime.now(),
                      lastDate:
                          bookingOptions?.availableTo != null
                ...
                if (bookingOptions?.type == "table")
                  DropdownButtonFormField<int>(
                    value:
                        selectedBooking["slotIndex"], // Store selected index instead of full slot
                    hint:
                        (widget.bookingSlotsData?.data?.isEmpty ?? true) &&
                                selectedBooking["date"] != null
                            ? Text(
                    ...
                    items: List.generate(
                      widget.bookingSlotsData?.data?.length ?? 0,
                      (index) {
                    ...
                    onChanged: (int? index) {
                      setState(() {
                        if (index != null) {
                          ...
                          selectedBooking["slot"] = {
                            "from":
                                widget.bookingSlotsData!.data![index].timestamp
                                    ?.split("-")[0] ??
                                "",
                            "to":
                                widget.bookingSlotsData!.data![index].timestamp
