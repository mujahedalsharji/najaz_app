...
class _ProductViewState extends State<ProductView> {
  ...
  @override
  void initState() {
    productFlats = widget.productData?.productFlats?.firstWhereOrNull(
      ...
      onRefresh: () {
        return Future.delayed(const Duration(seconds: 1), () {
          widget.productScreenBLoc?.add(
            FetchProductEvent(widget.productData?.urlKey ?? ""),
          );
        });
      },
      child: Stack(
