  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children:
            widget.customizableOptions.map((option) {
              switch (option.type) {
                case 'text':
              ...
              _setSelectedValue(option.id!, {
                ...
                'values':
                    set
                        .map(
                          (id) =>
                              option.customizableOptionPrices
      ...
      children: [
        ...
        ...?option.customizableOptionPrices?.map<Widget>((priceOption) {
          return RadioListTile<int>(
            ...
            selectedTileColor: theme.colorScheme.onBackground.withOpacity(
              0.1,
            ), // subtle highlight
            onChanged: (value) {
              _setSelectedValue(option.id!, {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: DropdownButton<int>(
            ...
            value: selected,
            items:
                option.customizableOptionPrices?.map<DropdownMenuItem<int>>((
                  priceOption,
                ) {
            ...
            onChanged: (value) {
              final priceOption = option.customizableOptionPrices?.firstWhere(
                (p) => p.id == value,
              );
              _setSelectedValue(option.id!, {
                'optionId': option.id,
