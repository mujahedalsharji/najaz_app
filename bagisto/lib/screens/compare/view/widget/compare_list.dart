...
class CompareList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      width:
          (compareScreenModel.data?.length ?? 0) *
            ...
            onTap: () {
              Navigator.pushNamed(
                ...
                arguments: PassProductData(
                  title: compareScreenModel.data?[index].product?.name ?? "",
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  compareScreenModel.data?[index].product?.averageRating != null
                      ? Padding(
                        padding: const EdgeInsets.fromLTRB(
                          AppSizes.spacingNormal,
                          AppSizes.spacingNormal,
                  ...
                  Opacity(
                    opacity:
                        (compareScreenModel.data?[index].product?.isSaleable ??
                                false)
                            ? 1
                            : 0.4,
                    child: Container(
