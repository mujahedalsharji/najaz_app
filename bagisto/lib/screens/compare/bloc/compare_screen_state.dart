...
class AddToCartCompareState extends CompareScreenBaseState {
  ...
  AddToCartCompareState.success({
    ...
    this.successMsg,
    this.cartProductId,
  }) : status = CompareStatusStatus.success;
...
class AddToWishlistCompareState extends CompareScreenBaseState {
  ...
  AddToWishlistCompareState.success({
    this.response,
    this.productDeletedId,
    this.successMsg,
  }) : status = CompareStatusStatus.success;
  AddToWishlistCompareState.fail({this.error})
    : status = CompareStatusStatus.fail;
}
...
class RemoveFromWishlistState extends CompareScreenBaseState {
  ...
  RemoveFromWishlistState.fail({this.error})
    : status = CompareStatusStatus.fail;
}
...
class RemoveAllCompareProductState extends CompareScreenBaseState {
  ...
  String? successMsg;
  BaseModel? baseModel;
  RemoveAllCompareProductState.success({this.successMsg, this.baseModel})
    : status = CompareStatusStatus.success;
  RemoveAllCompareProductState.fail({this.error})
    : status = CompareStatusStatus.fail;
}
...
class CompareScreenFetchDataState extends CompareScreenBaseState {
  ...
  CompareScreenFetchDataState.success({this.compareScreenModel})
    : status = CompareStatusStatus.success;

  CompareScreenFetchDataState.fail({this.error})
    : status = CompareStatusStatus.fail;
}
