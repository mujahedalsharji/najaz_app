...
import 'package:bagisto/data_model/account_models/account_info_details.dart';
...
class _DrawerListViewState extends State<DrawerListView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (GlobalData.cmsData != null) {
      ...
      drawerList.add(Divider());
      drawerList.add(CmsItemsList(cmsData: GlobalData.cmsData));
    }
    drawerList.add(
      Row(
        children: [
    ...
    drawerList.add(
      DrawerAddItemList(
        ...
        subTitle:
            (widget.customerCurrency ?? "").isEmpty
