  ...
  void mapEventToState(
    ...
    if (event is CurrencyLanguageEvent) {
      try {
        ...
        emit(
          FetchLanguageCurrencyState.success(
            currencyLanguageList: currencyLanguageList,
          ),
        );
      } catch (e) {
        emit(
          FetchLanguageCurrencyState.fail(
